...
function Arboreal(parent, data, id) {
	...
	this.children = [];
	this.drawData = {prelim : 0, modifier : 0, thread: 0, ancestor: this, expanded: true, visible: true,
...
Arboreal.prototype.hasLeftSibling = function () {
	if(typeof this.leftSibling() ==="undefined" || this.leftSibling() ===null){
		return false;
	} else{
		return true;
	}
...
Arboreal.prototype.leftSibling = function () {
	var idArray = this.id.split("/").pop();
	idArray--;
	return(this.parent)?this.parent.children[idArray]: null;
};

Arboreal.prototype.hasRightSibling = function () {
	if(typeof this.rightSibling() ==="undefined" || this.rightSibling() ===null){
			return false;
	} else{
		return true;
	}
...
Arboreal.prototype.rightSibling = function () {
  var idArray = this.id.split("/").pop();
  idArray++;
	return(this.parent)?this.parent.children[idArray]: null;
};

Arboreal.prototype.leftMostSibling = function () {
	return(this.parent)?this.parent.children[0]: null;
};

Arboreal.prototype.firstChild = function () {
	if(this.children.length > 0){
		return this.children[0];
	}
};

Arboreal.prototype.leftMostChild = function () {
	return this.firstChild();
};

Arboreal.prototype.rightMostChild = function () {
	if(this.children.length > 0){
		return this.children[this.children.length - 1];
	}
};

Arboreal.prototype.isSiblingOf = function (node) {
	if(this.parent && node.parent){
		return (this.parent.id == node.parent.id);
	}
	return false;
};

Arboreal.prototype.parent = function () {
	return this.parent;
};
